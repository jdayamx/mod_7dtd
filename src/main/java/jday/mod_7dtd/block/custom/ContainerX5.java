...
public class ContainerX5 extends BarrelBlock {
    public ContainerX5(Settings settings) {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        ...
        if (Objects.equals(state.getBlock().getName().getString(), "block.mod_7dtd.cntcupboardcabinetredtoploothelper")) {
            be.setStack(0, new ItemStack(ModItems.foodShamSandwich, getRandomNumber(0, 3)));
            be.setStack(1, new ItemStack(ModItems.foodCropPotato, getRandomNumber(0, 4)));
            be.setStack(2, new ItemStack(ModItems.foodRottingFlesh, getRandomNumber(0, 5)));
            be.setStack(3, new ItemStack(ModItems.foodCropCorn, getRandomNumber(0, 2)));
        }
        return be;
    }
