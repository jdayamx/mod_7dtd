...
public class BlockX1H3a extends Block {
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    public BlockX1H3a(Settings settings) {
        super(settings);
        ...
        switch(dir) {
            case NORTH:
                return VoxelShapes.union(
                        VoxelShapes.cuboid(0f, 0f, 0.8f, 1f, 1.0f, 1.0f),
                        VoxelShapes.cuboid(0.8f, 0.0f, 0.0f, 1f, 1.0f, 1.0f)
                );
            case SOUTH:
                return VoxelShapes.union(
                        VoxelShapes.cuboid(0.0f, 0.0f, 0f, 1.0f, 1.0f, 0.2f),
                        VoxelShapes.cuboid(0f, 0.0f, 0.0f, 0.2f, 1.0f, 1.0f)
                );
            case EAST:
                return VoxelShapes.union(
                        VoxelShapes.cuboid(0f, 0.0f, 0.0f, 0.2f, 1.0f, 1.0f),
